...
app.use(cors({
    origin: ['http://localhost:3000', 'https://realestateclubgvsu.com', 'https://gvsurealestateclub.com', 'https://real-estate-club.vercel.app'],
}));
...
if (process.env.GMAIL_EMAIL && process.env.GMAIL_APP_PASSWORD) {
    transporter = nodemailer.createTransport({
        ...
        connectionTimeout: 10000, // Increase connection timeout to 10 seconds (default is often lower)
        socketTimeout: 15000, 
        tls: {
